...
const SignedIn = createMaterialBottomTabNavigator(
  {
    ...
    Calendar: {
      ...
      navigationOptions: {
        tabBarIcon: ({ tintColor, focused }) => (
          <Icon size={25} name={"calendar"} style={{ color: tintColor }} />
        )
      }
    },
    Messaging: {
    ...
    Home: {
      ...
      navigationOptions: {
        drawerIcon: ({ tintColor, focused }) => (
          <Icon size={25} name={"home"} style={{ color: tintColor }} />
        )
      }
    },
    Account: {
      ...
      navigationOptions: {
        drawerIcon: ({ tintColor, focused }) => (
          <Icon size={25} name={"user"} style={{ color: tintColor }} />
        )
      }
    },
    Members: {
      ...
      navigationOptions: {
        drawerIcon: ({ tintColor, focused }) => (
          <Icon size={22} name={"users"} style={{ color: tintColor }} />
        )
      }
    },
    Settings: {
      ...
      navigationOptions: {
        drawerIcon: ({ tintColor, focused }) => (
          <Icon size={25} name={"gear"} style={{ color: tintColor }} />
        )
      }
    }
  },
